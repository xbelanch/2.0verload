...
Interpretar el excesivo volumen de información no es una tarea fácil. La instrucción en el aprendizaje de las herramientas poco incluye o nada la comunicación del *overloading*. El ejemplo más familiar son las hojas de cálculo. Si la competencia técnica de la herramienta nos ayuda a gestionar eficazmente las interminables filas y columnas de la hoja de cálculo, no ocurre lo mismo cuando se intenta facilitar un *relato visual* de aquella información tabular.
